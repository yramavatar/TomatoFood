...
const LoginPopup = ({setShowLogin}) => {
    ...
    // to take the data from input field and set the state 
    ...
    const onChangeHandler = (event)=>{
      ...
      // to verify it 
        ...
        // },[data])
         ...
         // to connect url with use login function 
    ...
    <div className='login-popup'>
        <form onSubmit={onLogin} className="login-popup-container">
            ...
            <div className="login-popup-condition">
                ...
                <p>By continuing,I agree to the terms of usage & privacy policy.</p>
            </div>
            {currState==="Login"
